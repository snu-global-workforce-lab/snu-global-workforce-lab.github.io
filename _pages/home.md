...
<div style="max-width: 980px; margin: 0 auto 26px auto;">
  <p style="font-size: 1.05rem; line-height: 1.65; margin: 0;">
    ...
    Our work informs policy reform and development cooperation through evidence and impact evaluation.
  </p>
</div>
...
<div style="max-width: 1100px; margin: 0 auto;">
  ...
  <div style="display:flex; gap:16px; flex-wrap:wrap; align-items:stretch;">
    ...
    <!-- Card 1 -->
    <div style="flex:1; min-width:260px; background:#111; border:1px solid rgba(255,255,255,0.10);
