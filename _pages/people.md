...
<div class="alumni-grid">
  ...
  <div class="alumni-card">
    <img class="alumni-photo" src="{{ '/images/people/alumni-placeholder.png' | relative_url }}" alt="Suhyun Bae">
  ...
  <div class="alumni-card">
    <img class="alumni-photo" src="{{ '/images/people/alumni-placeholder.png' | relative_url }}" alt="Jagyeong Park">
    <div class="alumni-meta">
  ...
  <div class="alumni-card">
    <img class="alumni-photo" src="{{ '/images/people/alumni-placeholder.png' | relative_url }}" alt="Seongji Jeong">
    <div class="alumni-meta">
  ...
  <div class="alumni-card">
    <img class="alumni-photo" src="{{ '/images/people/alumni-placeholder.png' | relative_url }}" alt="Jisik Min">
    <div class="alumni-meta">
  ...
  <div class="alumni-card">
    <img class="alumni-photo" src="{{ '/images/people/alumni-placeholder.png' | relative_url }}" alt="Gwiyeong Ko">
    <div class="alumni-meta">
  ...
  <div class="alumni-card">
    <img class="alumni-photo" src="{{ '/images/people/alumni-placeholder.png' | relative_url }}" alt="Hyunju Yoo">
    <div class="alumni-meta">
  ...
  <div class="alumni-card">
    <img class="alumni-photo" src="{{ '/images/people/alumni-placeholder.png' | relative_url }}" alt="Seokho Hong">
    <div class="alumni-meta">
